...
case 'menu':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
atakbotz.sendMessage(from, { audio: fs.readFileSync('Atak/sound3.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: fkontak })
let timestamp = speed()
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
atakbotz.sendMessage(from, { audio: fs.readFileSync('Atak/sound1.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: fkontak })
var Yy = 0
