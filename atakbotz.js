...
module.exports = atakbotz = async (atakbotz, m, chatUpdate, store) => {
try {
...
if (multipref) {
   var prefix = /^[°•π÷×¶∆£¢€¥®™✓_=|~!?#$%^&.+-,\/\\©^]/.test(body) ? body.match(/^[°•π÷×¶∆£¢€¥®™✓_=|~!?#$%^&.+-,\/\\©^]/gi) : '#'
    ...
    prefix = preff
        ...
        const botNumber = await atakbotz.decodeJid(atakbotz.user.id)
        ...
        const groupMetadata = m.isGroup ? await atakbotz.groupMetadata(m.chat).catch(e => {}) : ''
...
// CONST SEND MESSAGE
atakbotz.sendnew = async (satu, dua, tiga) => {return await generateWAMessage(satu, dua, {...tiga ,userJid: atakbotz.authState.creds.me.id,upload: atakbotz.waUploadToServer})}      
...
{"urlButton": {"displayText": "OWNER","url": "https://wa.me/" + global.owner}},
...
atakbotz.relayMessage(satu, menu1.message, { messageId: menu1.key.id })}

        const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `6283136505591-1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `${pushname}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}

        const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 999999,status: 200, thumbnail: thumb, surface: 200, message: `© ${namaownernya}`, orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}

        const ads = (teks) => {
atakbotz.sendMessage(from, { text : teks, contextInfo: {"externalAdReply": { title: "WHASTAPP BOT 2022",mediaType: 3,renderLargerThumbnail: false, showAdAttribution: true, body: "",thumbnail: fs.readFileSync('./Image/wpmobile.png'),sourceUrl: "https://nekopoi.care"}}})
}
    
    const fakey = (teks) => {
            atakbotz.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Halo Kak ${pushname}`,"body": `Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./Image/fenzo.jpg`),"sourceUrl": "https://chat.whatsapp.com/J1co9yOpbeG5ybax7i4kYk"}}}, { quoted: m})
        }
...
atakbotz.sendMessage(from, { text: sendResponList(from, body, db_respon_list) }, {
quoted: m
})
} else {
atakbotz.sendMessage(from, { image: await getBuffer(get_data_respon.image_url), caption: get_data_respon.response }, {
quoted: m
})
}
}
...
// auto set bio
	if (db.data.settings[botNumber].autobio) {
		...
		await atakbotz.setStatus(`${atakbotz.user.name} | Runtime : ${runtime(uptime)}`)
...
if(replyType === "web2"){
atakbotz.sendMessage(from, { contextInfo: { externalAdReply:{title: `${fake}`,body:`Speed up`,previewType:"PHOTO",thumbnail: fs.readFileSync('./stik/reply.jpg'), sourceUrl:`https://youtu.be/zbZvrsvsr00`}}, text: teks })
} else if(replyType === "web"){
atakbotz.sendMessage(from, { contextInfo: {  forwardingScore: 9999,
            isForwarded: true, showAdAttribution: true,   externalAdReply:{title: `${fake}`,body:`Speed up`,previewType:"PHOTO",thumbnail: fs.readFileSync('./stik/reply.jpg'), sourceUrl:`https://youtu.be/zbZvrsvsr00`}},showAdAttribution: true, text: teks }, { showAdAttribution: true, quoted: atakbotz })
} else if(replyType === "mess"){
atakbotz.sendMessage(from, {text: teks}, { quoted: atakbotz });
} else if(replyType === "quoted"){
atakbotz.sendMessage(from,{ text: teks}, { quoted: setQuoted });
} else {
atakbotz.sendMessage(from, {text: "Error SetReply Tidak Di Temukan"})
}
}	
		
		
		
		if (m.sender.startsWith('212')) return atakbotz.updateBlockStatus(m.sender, 'block')

	    atakbotz.sendReadReceipt(from, sender, [m.key.id])
		atakbotz.sendPresenceUpdate('available', from)
		
		if (m.sender.startsWith('212')) return atakbotz.groupParticipantsUpdate(m.chat, [sender], 'remove')
		
		try {
        ppuser = await atakbotz.profilePictureUrl(m.sender, 'image')
        } catch (err) {
...
img: await resz.getBufferAsync(jimp.MIME_JPEG)
        ...
        const sendFileFromUrl = async (from, url, caption, m, men) => {
            ...
            if (mime.split("/")[1] === "gif") {
                return atakbotz.sendMessage(from, { video: await getBuffer(url), caption: caption, gifPlayback: true, mentions: men ? men : [], mimetype: 'video/mp4'}, {quoted: m})
                }
            let type = mime.split("/")[0]+"Message"
            if(mime === "application/pdf"){
                return atakbotz.sendMessage(m.chat, { document: await getBuffer(url), mimetype: 'application/pdf', caption: caption, mentions: men ? men : []}, {quoted: m })
            }
            if(mime.split("/")[0] === "image"){
                return atakbotz.sendMessage(m.chat, { image: await getBuffer(url), caption: caption, mentions: men ? men : []}, {quoted: m})
            }
            if(mime.split("/")[0] === "video"){
                return atakbotz.sendMessage(m.chat, { video: await getBuffer(url), caption: caption, mentions: men ? men : [], mimetype: 'video/mp4'}, {quoted: m })
            }
            if(mime.split("/")[0] === "audio"){
                return atakbotz.sendMessage(m.chat, { audio: await getBuffer(url), caption: caption, mentions: men ? men : [], mimetype: 'audio/mpeg'}, {quoted: m })
            }
        }
        ...
        let messages = await generateWAMessage(m.chat, { text: text, mentions: mentionedJid }, {
            userJid: atakbotz.user.id,
            quoted: m.quoted && m.quoted.fakeObj
        })
        messages.key.fromMe = areJidsSameUser(m.sender, atakbotz.user.id)
        ...
        atakbotz.ev.emit('messages.upsert', msg)
        }

		const reply = async(teks) => {
        atakbotz.sendMessage(m.chat, { text : teks, mentions: await atakbotz.parseMention(teks), contextInfo : {
        "forwardingScore":999,
        "isForwarded":true, 
...
'jpegThumbnail': fs.readFileSync('./Image/diamond.jpg')
        ...
        const sticWait = (hehe) => {
			...
			atakbotz.sendMessage(hehe, { sticker: ano, contextInfo: {
			forwardingScore:999,
            isForwarded:true, 
            mentionedJid: [m.sender],
			externalAdReply: { 
			...
			thumbnail: ppnyauser, 
			previewType: "FOTO",
			sourceUrl: `https://chat.whatsapp.com/FXY0OMAJeiD9ZtaDvzIGVT`}}}, 
			{ quoted: floc })
		}
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, atakbotz.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, atakbotz.user.name, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, atakbotz.user.name, m)
	    ...
	    deskripsi = caklontong_desk[m.sender.split('@')[0]]
            if (budy.toLowerCase() == jawaban) {
                await atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `🎮 Cak Lontong 🎮\n\nJawaban Benar 🎉\n*${deskripsi}*\n\nIngin bermain lagi? tekan button dibawah`, atakbotz.user.name, m)
        ...
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, atakbotz.user.name, m)
        ...
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, atakbotz.user.name, m)
	...
	if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, atakbotz.user.name, m)
                delete tebaktebakan[m.sender.split('@')[0]]
            } else reply('*Jawaban Salah!*')
        }
        
      
_sewa.expiredCheck(atakbotz, sewa)
...
atakbotz.relayMessage(jid, order.message, { messageId: order.key.id})
}
        
        if (m.isGroup && !m.key.fromMe &&  db.data.chats[m.chat].antilink && !isCreator && !isGroupAdmins){
        if (budy.match(`https://chat.whatsapp.com`)) {
        atakbotz.sendMessage(m.chat, {text: `*Antilink Group Terdeteksi*\n\nKamu Akan Dikeluarkan Dari Group ${groupMetadata.subject}`}, {quoted:m})
	    atakbotz.groupParticipantsUpdate(m.chat, [sender], 'remove')
		}
	    }
	    
	    if (m.isGroup && !m.key.fromMe &&  db.data.chats[m.chat].antiwame && !isGroupAdmins){
        if (budy.match(`wa.me`)) {
        atakbotz.sendMessage(m.chat, {text: `*Antiwame Group Terdeteksi*\n\nKamu Akan Dikeluarkan Dari Group ${groupMetadata.subject}`}, {quoted:m})
	    atakbotz.groupParticipantsUpdate(m.chat, [sender], 'remove')
		}
	    }
        ...
        atakbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: await getBuffer(data.thumb) }, templateButtons: button, footer: `Pilih Salah Satu Button Dibawah⬇️`, mentions: [sender] })
        }).catch((e) => {
        atakbotz.sendMessage(from, { text: mess.error }, { quoted: fakeatakbotz })
        ownerNumber.map( i => atakbotz.sendMessage(from, { text: `Send Play Error : ${e}` }))
        })
        }
...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 × ${prefix}sellemas
 × ${prefix}selldiamond`
        atakbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: thumbrpg }, templateButtons: button, footer: `Rpg Game By XzyBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
「 PROFILE 」
 ...
 • Xp :  ${getLevelingXp(sender)}/${reqXp}
「 RPG GAME 」`
        atakbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgjoinrpg }, templateButtons: button, footer: `Rpg Game By XzyBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
addDm(sender, d)
        ...
        atakbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgslime }, templateButtons: button, footer: `Rpg Game By XzyBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
atakbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imggoblin }, templateButtons: button, footer: `Rpg Game By Xzybotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
atakbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdevil }, templateButtons: button, footer: `Rpg Game By XzyBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
atakbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgbehemoth }, templateButtons: button, footer: `Rpg Game By Xzybotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
atakbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdemon }, templateButtons: button, footer: `Rpg Game By XzyBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
atakbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdemonking }, templateButtons: button, footer: `Rpg Game By XzyBotz`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
async function replyTemplate(teks) {
                       ...
                       const buttonMessage = { 
                                    text: teks, 
                                    footer: "Bot By XzyBotz", 
                                    templateButtons: buttonsDefault, 
                                    image: {url: thumb}                                   
                                               }
                       return atakbotz.sendMessage(from, buttonMessage)
                }
...
var button = [
{"urlButton": {"displayText": "Owner","url": `https://wa.me/6285850063401`}},
{"quickReplyButton": {"displayText": "Sewabot","id": 'sewabot'}},
{"quickReplyButton": {"displayText": "Status Bot XzyBot","id": 'ping'}}
		]
atakbotz.sendMessage(from, { caption: teks, location: { jpegThumbnail: thumb }, templateButtons: button, footer: `Owner Bot : ${owner.length}`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
let encmedia = await atakbotz.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return replyNya('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await atakbotz.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
}
}
...
try {
let cret = await atakbotz.groupCreate(args.join(" "), [])
let response = await atakbotz.groupInviteCode(cret.id)
...
https://chat.whatsapp.com/${response}
       `
atakbotz.sendMessage(m.chat, { text:teks, mentions: await atakbotz.parseMention(teks)}, {quoted:m})
} catch {
reply("Error!")
}
}
...
try {
reply(`// Created By xzybotz\n` + 'case ' + `'${args[0]}'` + fs.readFileSync('./atakbotz.js').toString().split(`case '${args[0]}'`)[1].split(turbrek)[0] + turbrek)
} catch {
...
atakbotz.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Fitur Nulis By atakbotz ", fejfjej, { quoted: fakeatakbotz })
addCmd(command.slice(0), 1, commund)
break
case 'nuliskiri':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
.on('exit', () => {
atakbotz.sendMessage(from, { image: fs.readFileSync('./Atak/FOTO/BUKU/setelahkiri.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
})
}
addCmd(command.slice(0), 1, commund)
break
...
replyNya(mess.wait)
                ...
                .on('error', () => reply('error'))
                .on('exit', () => {
                atakbotz.sendMessage(from, { image: fs.readFileSync('./Atak/FOTO/BUKU/setelahkanan.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
            addCmd(command.slice(0), 1, commund)
                break
...
replyNya(mess.wait)
                ...
                .on('error', () => reply('error'))
                .on('exit', () => {
                atakbotz.sendMessage(from, { image: fs.readFileSync('./Atak/FOTO/FOLIO/setelahkiri.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
            addCmd(command.slice(0), 1, commund)
                break
...
replyNya(mess.wait)
                ...
                .on('exit', () => {
                atakbotz.sendMessage(from, { image: fs.readFileSync('./Atak/FOTO/FOLIO/setelahkanan.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
            addCmd(command.slice(0), 1, commund)
                break
...
atakbotz.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Topup Game By XzyBot ", secmmknya, { quoted: efff })
addCmd(command.slice(0), 1, commund)
break
case 'topup5':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
let message = await prepareWAMessageMedia({ image: fs.readFileSync('./Image/ovoatak.jpg') }, { upload: atakbotz.waUploadToServer })
...
atakbotz.relayMessage(m.chat, template.message, { messageId: template.key.id })
}
addCmd(command.slice(0), 1, commund)
break
case 'topup12':{
...
const isblocks = await atakbotz.fetchBlocklist()
const isBlock = isblocks.includes(jidny)
texnr = `     「 Profile Inspector 」
▸ Number : ${jidny.split("@")[0]}
▸ Mention : @${jidny.split("@")[0]}
▸ Name : ${atakbotz.getName(jidny)}
▸ Biography : ${jsonformat(await atakbotz.fetchStatus(jidny).catch(() => {}))}
▸ Business : ${jsonformat(await atakbotz.getBusinessProfile(jidny))}
...
▸ Blocatak : ${isBlock}`
try {
ppuser = await atakbotz.profilePictureUrl(jidny, 'image')
} catch {
ppuser = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
atakbotz.sendMessage(m.chat, { image: { url: ppuser }, caption: texnr, mentions: await atakbotz.parseMention(texnr), contextInfo:{externalAdReply:{
...
teks = '*List Banned*\n\n'
for (let atakbotz of ban) {
teks += `- ${atakbotz}\n`
}
teks += `\n*Total : ${ban.length}*`
atakbotz.sendMessage(from, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": ban } })
addCmd(command.slice(0), 1, commund)
break
case 'ban':
...
ads(`Send Image/Video With Caption ${prefix + command}\nVideo Duration 1-9 Seconds`)
}
}
break
case 'wm': case 'take': case 'swm': case 'stickerwm': {
if (!args.join(" ")) return ads(`Example :\nswm Mya APIs | MyMainas`)
const swn = args.join(" ")
const pcknm = swn.split("|")[0];
const atnm = swn.split("|")[1];
if (m.quoted.isAnimated === true) {
atakbotz.downloadAndSaveMediaMessage(quoted, "gifee")
atakbotz.sendMessage(from, {sticker:fs.readFileSync("gifee.webp")},{quoted:m})
} else if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await atakbotz.sendImageAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return ads('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await atakbotz.sendVideoAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
await fs.unlinkSync(encmedia)
} else {
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!text) return ads(`Kirim/Reply Foto Dengan Caption ${prefix + command} *teks*`)
if (text.includes('|')) return ads(`Kirim/Reply Foto Dengan Caption ${prefix + command} *teks*`)
if (!/image/.test(mime)) return ads(`Kirim/Reply Foto Dengan Caption ${prefix + command} *teks*`)
ads(mess.wait)
arg = args.join(' ')
mee = await atakbotz.downloadAndSaveMediaMessage(quoted)
const { TelegraPh } = require('./Lib/uploader')
mem = await TelegraPh(mee)
meme = `https://api.memegen.link/images/custom/-/${arg}.png?background=${mem}`
memek = await atakbotz.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
...
if (!isPrem) return replyPremium(mess.premium)
                ...
                if (args[0] === "lagu") {
                    ...
                    let msg = await atakbotz.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: fakeatakbotz })
                    atakbotz.sendText(m.chat, `Judul Lagu Nya Apa??\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
                    tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, atakbotz.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    atakbotz.sendImage(m.chat, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
                    tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, atakbotz.user.name, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    atakbotz.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
                    tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkata[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, atakbotz.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, atakbotz.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    atakbotz.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
                    tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklirik[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, atakbotz.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    atakbotz.sendText(m.chat, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    atakbotz.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `Waktu Habis\nJawaban:  ${caklontong[m.sender.split('@')[0]]}\nDeskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, atakbotz.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
...
if (!isPrem) return replyPremium(mess.premium)
                ...
                atakbotz.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
let message = await prepareWAMessageMedia({ image: hasil }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
let message = await prepareWAMessageMedia({ image: memeall }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
let message = await prepareWAMessageMedia({ image: highschooldxd }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
let message = await prepareWAMessageMedia({ image: swordartonline }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
let message = await prepareWAMessageMedia({ image: lovelive }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
if (!m.key.fromMe && !isCreator) return replyNya(mess.owner)
teks = '*List Premium*\n\n'
for (let atakbotz of prem) {
teks += `- ${atakbotz}\n`
}
teks += `\n*Total : ${prem.length}*`
atakbotz.sendMessage(from, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": prem } })
addCmd(command.slice(0), 1, commund)
break
case 'addprem':
if (!m.isGroup) return replyNya(mess.group)
...
ads(`Nomor ${bnnd} Telah Menjadi Premium!`)
addCmd(command.slice(0), 1, commund)
break
case 'delprem':
if (!m.isGroup) return replyNya(mess.group)
...
prem.splice(unp, 1)
fs.writeFileSync('./Database/premium.json', JSON.stringify(prem))
ads(`Nomor ${ya} Telah Di Hapus Premium!`)
addCmd(command.slice(0), 1, commund)
break
case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
                ...
                if (/audio/.test(mime)) {
                ads(mess.wait)
                let media = await atakbotz.downloadAndSaveMediaMessage(quoted)
                let ran = getRandom('.mp3')
                exec(`ffmpeg -i ${media} ${set} ${ran}`, (err, stderr, stdout) => {
                fs.unlinkSync(media)
                if (err) return ads(err)
                let buff = fs.readFileSync(ran)
                atakbotz.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted: fakeatakbotz })
                fs.unlinkSync(ran)
                })
...
atakbotz.sendMessage(m.chat, {audio: inicdd, mimetype:'audio/mpeg', ptt:true }, { quoted: fkontak })
addCmd(command.slice(0), 1, commund)
break
case 'tts':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, {audio: { url: inimmk.result }, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
addCmd(command.slice(0), 1, commund)
break
case 'creator': case 'owner': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
atakbotz.sendContact(m.chat, global.owner, m)
}
addCmd(command.slice(0), 1, commund)
break
           break
...
• Wita : ${wita}`
                ...
                atakbotz.send5ButImg(m.chat, anu, atakbotz.user.name, global.thumb, button)
            }
            break
case 'quest':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Rpg Game By XzyBotz ", sectionnya, { quoted: fkontak})
addCmd(command.slice(0), 1, commund)
break
case 'slime':
case 'killslime':
...
break
case 'groupxzybotz': {
await replyTemplate(`${gcatakbotz}\nGak Join Awas Di Ban Kau`)
}
addCmd(command.slice(0), 1, commund)
break
case 'sc': case 'script':{
await replyTemplate(`Beli Bang Murah Kok`) 
}
addCmd(command.slice(0), 1, commund)
break
case 'menu':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
atakbotz.sendMessage(from, { audio: fs.readFileSync('Atak/sound5.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: fkontak })
let timestamp = speed()
let latensi = speed() - timestamp
const botxzy = "6285850063401@s.whatsapp.net"
...
var bybarr = rndm[Math.floor(Math.random() * rndm.length)]
...
Selamat Mencoba Dengan Fitur Xzy Bot Yang Super GG Dan Jangan Lupa Donasi Ya Kak Xixixi\n\nJika Ingin Sewa Bot Ketik ${prefix}sewabot\n\n Note : No Spam Bot Kalau Ketahuan Spam Block Dan Ban Permanen Jangan Telpon/Vc Owner Juga Ngab Nanti Di Block Mau Kenalan Dengan Owner Saya wa.me/6285850063401.`
let buttons = [
...
fileName: `Bot By XzyBotz`, 
mimetype: `application/${bybarr}`,
jpegThumbnail: thumb,
caption: mbc,
footer: `_Powered By @${botxzy.split("@")[0]}_`,
fileLength: "999999999", 
mentions:[sender, botxzy],
buttons: buttons,
headerType: 4,
contextInfo: {
"mentionedJid": [sender, botxzy],
"externalAdReply": {
...
atakbotz.sendMessage(m.chat, buttonMessage, { quoted: {
				  key: {
				   fromMe: false,
				   participant: `0@s.whatsapp.net`,
				   remoteJid: "120363039634404724@g.us"
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
atakbotz.sendMessage(from, { audio: fs.readFileSync('Atak/sound6.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: fkontak })
var Yy = 0
var head = `╭───╼[ *XZYBOTZ-BARR* ]╾──➲`  
...
┌──❒『 ${ya}INFORMATION${ya} 』
${ya}• Your Name${ya} : ${pushname}
${ya}• Library${ya} : Baileys-Md
${ya}• Version${ya} : 2.0.0
${ya}• Language${ya} : Javascript
${ya}• Date Server${ya} :  ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}
${ya}• Time Sever${ya} : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}
_*TOTAL FITUR : 643*_
͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏┗────   
...
➭ ${ya}${Yy+=1} ${prefix}groupxzybotz${ya}
...
➭ ${ya}${Yy+=1} ${prefix}ffid <id ff>${ya}
➭ ${ya}${Yy+=1} ${prefix}mlid <id|zoneid>${ya}
...
atakbotz.send5Loc(m.chat, `On Kak Silahkan Pencet Button Di Bawah\nJika Button Tidak Kelihatan Ketik ${prefix}menu`, `Created By XzyBot`, global.thumb, btn)
}
addCmd(command.slice(0), 1, commund)
break
case 'allmenu': {
...
➭ ${ya}${Yy+=1} ${prefix}listmsg${ya}
  `
  textTemplateButtons(m.chat, anu, `atakbotz`, btn)
            }
break
case 'donwloadmenu': {
	            anu = `
...
break
case 'p': case 'bot':{
atakbotz.sendMessage(from, { audio: fs.readFileSync('Atak/sound4.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: fkontak })
}
break
case 'galau':{
atakbotz.sendMessage(from, { audio: fs.readFileSync('Atak/sound5.mp3'), mimetype: 'audio/mp4', ptt: true}, { quoted: fkontak })
...
let message = await prepareWAMessageMedia({ image: fs.readFileSync('./Image/atakbotz.jpg') }, { upload: atakbotz.waUploadToServer })
}
break
case 'Nindi': case 'zidni':{
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
            	if (!m.key.fromMe && !isCreator) return replyNya(mess.owner)
                 ...
                 atakbotz.sendTextWithMentions(m.chat, teks, m)
             }
             break
case 'liston': case 'listonline':{
             	if (!isGroupAdmins && !isGroupOwner) return ads(mess.admin)
             	   let id = args && /\d+\-\d+@g.us/.test(args[0]) ? args[0] : m.chat
                    let online = [...Object.keys(store.presences[id]), botNumber]
                    atakbotz.sendText(m.chat, 'List Online:\n\n' + online.map(v => '⭔ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
                    }
                    break
...
atakbotz.sendMessage(m.chat, buttonMessage, { quoted: fakeatakbotz })
})
}
break
case 'block': {
		...
		await atakbotz.updateBlockStatus(users, 'block').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
break
case 'unblock': {
		if (!isCreator) return replyNya(mess.owner)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await atakbotz.updateBlockStatus(users, 'unblock').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
...
if (/webp/.test(mime)) {
atakbotz.sendMessage(i, { sticker: { url: media } }, { quoted: fakeatakbotz })
} else if (/image/.test(mime)) {
let junn = `*_BROADCAST IMAGE_*${text ? '\n\n' + text : ''}`
atakbotz.send5ButImg(i, junn, `Created By XzyBotz`, buffer, butoon)
} else if (/video/.test(mime)) {
let junn = `*_BROADCAST VIDIO_*${text ? '\n\n' + text : ''}`
atakbotz.send5Vid(i, junn, `Created By XzyBotz`, buffer, butoon)
} else if (/audio/.test(mime)) {
atakbotz.sendMessage(i, {audio: buffer, mimetype: 'audio/mpeg'}, { quoted : m })
} else {
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      atakbotz.send5ButImg(yoi, txt, atakbotz.user.name, global.thumb, btn)
		}
...
atakbotz.sendButMessage(from, `MODE AUTOREAD`, `Silahkan pilih salah satu`, [
...
await atakbotz.sendKatalog(Pe, virtex8(prefix), virtex8(prefix), thumb, {quoted: setQuoted})
let a = await atakbotz.sendMessage(from, { react: { text: "0️", key: { remoteJid: from, fromMe: true, id: dev.id } } })
atakbotz.sendMessage(Pe, { text: "awowkwkwk" }, { quoted: a });
...
let btn = [{
                      ...
                      atakbotz.send5Vid(m.chat, `Nih Kak`, atakbotz.user.name, hasiltt, btn)
                      }
                      break
case 'asupan':
...
console.log(a2.url) 
atakbotz.sendMessage(from, {video : { url : xm2.url }, caption : 'nih'}) 
...
console.log(a2.url) 
atakbotz.sendMessage(from, {video : { url : a2.url }, caption : 'nih'}) 
} else if (q.toLowerCase() === "rikagusriani") {
const oi = geayubi
const jsonData = JSON.parse(oi);
const atakbotz1 = Math.floor(Math.random() * jsonData.length);
const atakbotz2 = jsonData[xm1];
console.log(atakbotz2.url) 
atakbotz.sendMessage(from, {video : { url : atakbotz2.url }, caption : 'nih'}) 
} else {
...
atakbotz.sendMessage(m.chat, { video: { url: hasiltod.result }, mimetype: 'video/mp4', fileName: `asupan.mp4`, caption: `Nih Asupan Nya` }, { quoted: fakeatakbotz })
}
break
case 'ghea':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { video: { url: hasilwjd.result.url }, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Asupan Nya` }, { quoted: fakeatakbotz })
}
break
case 'ukhty':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { video: { url: hasifs.result.url }, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Asupan Nya` }, { quoted: fakeatakbotz })
}
break
case 'santuy':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { video: { url: hasily.result.url }, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Asupan Nya` }, { quoted: fakeatakbotz })
}
break
case 'bokep':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Bokep Nya` }, { quoted: fakeatakbotz })
}
break
case 'storyanime':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { video: { url: hasiltod.result }, mimetype: 'video/mp4', fileName: `storyanime.mp4`, caption: `Nih Story Animenya` }, { quoted: fakeatakbotz })
}
break
case 'out':{
if (!isCreator) return replyNya(mess.owner)
atakbotz.groupLeave(from)
}
break
case 'public': {
if (!isCreator) return replyNya(mess.owner)
...
atakbotz.sendMessage(m.chat, { image: buffer }, { quoted: fakeatakbotz })
fs.unlinkSync(ran)
})
}
break
...
.then(({data}) => {
atakbotz.sendImageAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author })
})
break
case 'attp':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { sticker: gehdhe }, { quoted: fakeatakbotz })
break
case 'ttp':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (args.length == 0) return replyNya(`Contoh: ${prefix + command} Hai`)
...
atakbotz.sendMessage(m.chat, { sticker: veireuue }, { quoted: fakeatakbotz })
break
...
await atakbotz.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Converted From Webp To Video' } }, { quoted: fakeatakbotz })
await fs.unlinkSync(media)
}
break
case 'tourl': {
...
atakbotz.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
}
break
case 'tomp3': {
...
let { toAudio } = require('./Lib/converter')
let audio = await toAudio(media, 'mp4')
atakbotz.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Converted By ${atakbotz.user.name} (${m.id}).mp3`}, { quoted : m })
}
break
...
atakbotz.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
}
break
case 'togif': {
if (!m.quoted) return reply('Reply Image')
...
let media = await atakbotz.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await atakbotz.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Converted From Webp To Gif' }, gifPlayback: true }, { quoted: fakeatakbotz })
await fs.unlinkSync(media)
}
break
case 'emojimix':
...
let encmedia = await atakbotz.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
break
case 'emoji':
...
let encmedia = await atakbotz.sendImageAsSticker(m.chat, titor, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
break
case 'dadu':
case 'patrick':
...
atakbotz.sendMessage(m.chat, { sticker: buffer }, { quoted: fkontak })
break
case 'faktaunik': 
case 'katabijak': 
case 'pantun': 
...
atakbotz.sendMessage(m.chat, buttonMessage, { quoted: fkontak })
}
break
case 'quotes':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, {document: mnya, mimetype: 'application/zip', fileName: `${kfeh.result.filename}`}, {quoted:fakeatakbotz}).catch ((err) => reply(oh))
}
break
case 'iqra': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:fakeatakbotz}).catch ((err) => reply(oh))
}
break
...
if (args[0] === 'pdf') {
ads(mess.wait)
atakbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:fakeatakbotz})
} else if (args[0] === 'docx') {
ads(mess.wait)
atakbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:fakeatakbotz})
} else if (args[0] === 'pptx') {
sticWait(from)
atakbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:fakeatakbotz})
} else if (args[0] === 'xlsx') {
sticWait(from)
atakbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:fakeatakbotz})
} else {
...
let message = await prepareWAMessageMedia({ image: buff }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
if (!isPrem) return replyPremium(mess.premium)
                    ...
                    await atakbotz.sendMessage(m.chat, { image: eahdw, caption: ini_txt }, { quoted: fakeatakbotz})                  
                    break
case 'pinterest':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
sticWait(from)
                    ...
                    await atakbotz.sendMessage(m.chat, { image: ini_buffer, caption: '*PINTEREST IMAGE*' }, { quoted: fakeatakbotz})                  
                    break
case 'pinterest2':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
                    if (args.length == 0) return reply(`Example: ${prefix + command} loli kawaii`)
                    ...
                    for (var x = 0; x <= 5; x++) {
                        ...
                        await await atakbotz.sendMessage(m.chat, { image: ini_buffer, caption: '*PINTEREST IMAGE*' }, { quoted: fakeatakbotz})                  
                    }
                    break
case 'character':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
sticWait(from)
                    ...
                    await atakbotz.sendMessage(m.chat, { image: gnejws, caption: ini_txt }, { quoted: fakeatakbotz})                  
                    break
case 'manga':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
sticWait(from)
                    ...
                    await atakbotz.sendMessage(m.chat, { image: cehdhw, caption: ini_txt }, { quoted: fakeatakbotz})                  
                    break
case 'kusonime':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
let message = await prepareWAMessageMedia({ image: ini_buffer }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
sticWait(from)
             ...
             let message = await prepareWAMessageMedia({ image: mvn }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: imagenya }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: dwruw }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
case 'lava': case 'rock': case 'bloodglas': case 'hallowen': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
             if (!q) return reply(`Example : ${prefix + command} XzyBotz`) 
             ads(mess.wait)
             let link
             ...
             let anu = await maker.textpro(link, q)
                atakbotz.sendMessage(m.chat, { image: { url: anu }, caption: `*Done*` }, { quoted: fakeatakbotz })
             }
break
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: imagetod }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
if (args.length == 0) return replyNya(`Example: ${prefix + command} Atak Botz`)
sticWait(from)
txt1 = args[0]
txt2 = args[1]
...
sticWait(from)
                    ...
                    atakbotz.sendMessage(m.chat, { image: ini_buffer, caption: `*KTP MAKER*` }, { quoted: fakeatakbotz})
                    break
case 'tiktokmaker':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
if (!isPetualang) return ads(mess.noPetualang)
await sendButLoc(from)
break
case 'joinrpg':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) return ads(mess.group)  
if (isPetualang) return ads('Kamu Sudah Menjadi Petualang')
if (args.length < 1) return ads(`Kirim perintah ${prefix + command} nama`)
...
atakbotz.sendButtonText(m.chat, buttons, `Selesai Mining🚧\nlist hasil :\nEmas : ${emas}🪙\nUang : $${pp}💰\nBesi : ${besi}⛓️\nBerlian : ${dm}💎`, atakbotz.user.name, m)
}, 9000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: '🚧 Selesai Menguli . . .🪙👷' }, { quoted: fakeatakbotz })
}, 7000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: '🚧 Menemukan Emas . . .⚒️🏔️️️' }, { quoted: fakeatakbotz })
}, 4000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: '🚧 Mulai Menambang . . .⚒️🏔️️' }, { quoted: fakeatakbotz })
}, 1500) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: mining }, {quoted: fakeatakbotz}) 
}, 0) // 1000 = 1s,
break
case 'inventori':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendButtonText(m.chat, buttons_ridho_gay, `📍 𝗣𝗿𝗼𝗳𝗶𝗹𝗲 𝗣𝗹𝗮𝘆𝗲𝗿\n • Nama : ${pushname}\n • Rank : ${role}\n • Status : ${elit}\n • Xp : ${getLevelingXp(sender)}/${reqXp}\n • Level : ${getLevelingLevel(sender)}\n🎒 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝗶 :\n • Emas : ${getEmas(sender)}🪙\n • Uang : $${(getBalance(sender, balance))}💰\n • Besi : ${getBesi(sender)}⛓️\n • Berlian : ${getDm(sender)}💎\n • Ikan : ${getFish(sender)}🎣`, atakbotz.user.name, m)
break
case 'sellikan':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) return replyNya(mess.group) 
...
atakbotz.sendButtonText(m.chat, buttons, `🛒 𝗣𝗔𝗦𝗔𝗥\n • Penjual : ${pushname}\n • Pembeli : Admin\n • Harga/Ikan : 5\n • Status : Sukses\n • Sisa Ikan : ${getFish(sender)}\n • Hasil Penjualan : $${rp}`,  atakbotz.user.name, m)
break
case 'sellbesi':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) return replyNya(mess.group) 
...
atakbotz.sendButtonText(m.chat, buttons, `🛒 𝗣𝗔𝗦𝗔𝗥\n • Penjual : ${pushname}\n • Pembeli : Admin\n • Harga/Dm : 75\n • Status : Sukses\n • Sisa Diamond : ${getDm(sender)}\n • Hasil Penjualan : $${etoo}`, atakbotz.user.name, m)
break 
case 'mancing':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) return replyNya(mess.group) 
...
var button = [
        ...
        atakbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: cing }, templateButtons: button, footer: `Rpg Game By XzyBotz`, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 6000)
setTimeout( () => {
atakbotz.sendMessage(from, { text: 'Berhasil Mendapatkan Ikan . . .' }, { quoted: fakeatakbotz })
}, 5000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: '🎣 Menarik Kail. . .' }, { quoted: fakeatakbotz })
}, 3000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: '🎣 Mulai Memancing . . .' }, { quoted: fakeatakbotz })
}, 1500) // 1000 = 1s,
...
var button = [
        ...
        var hg = `「 DEATH 」\n\n • Tempat  ${ad}\n • MONEY : $${money}\n • EXP : ${adven}Xp`
        atakbotz.sendMessage(from, { caption: hg, location: { jpegThumbnail: hasm }, templateButtons: button, footer: `Rpg Game By Atakbotz`, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 7000)
setTimeout( () => {
atakbotz.sendMessage(from, { text: `Awass` }, { quoted: fakeatakbotz })
}, 5000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: `Tiba Tiba Ada ${sesuatu}` }, { quoted: fakeatakbotz })
}, 3000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: `${pushname} Sedang Bertualang` }, { quoted: fakeatakbotz })
}, 1500) // 1000 = 1s,
...
atakbotz.sendButtonText(m.chat, buttons, `🎰 Lucky\n• Uang : $${b}\n• Emas : ${a}\n• Besi : ${c}\n• Xp : ${ez}`, atakbotz.user.name, m)
}
break
case 'cecan2':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: { url: imgd.result.url } }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
await atakbotz.groupAcceptInvite(result).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
...
let response = await atakbotz.groupInviteCode(m.chat)
atakbotz.sendText(m.chat, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
...
atakbotz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
}
break
case 'antivirtex': 
case 'antivirtek':
if (isBan) return ads('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isCreator) return ads(mess.owner)
if (args[0] === "on") {
if (global.db.data.chats[m.chat].antivirtex) return replyNya('Sudah Aktif Sebelumnya')
global.db.data.chats[m.chat].antivirtex = true
ads(`antivirtex Berhasil Di Aktifkan !`)
} else if (args[0] === "off") {
if (!global.db.data.chats[m.chat].antivirtex) return replyNya('Sudah Nonaktif Sebelumnya')
global.db.data.chats[m.chat].antivirtex = false
ads(`antivirtex Berhasil Di Nonaktifkan !`)
} else {
let buttons = [
{ buttonId: 'antivirtex on', buttonText: { displayText: 'On' }, type: 1 },
{ buttonId: 'antivirtex off', buttonText: { displayText: 'Off' }, type: 1 }
]
await atakbotz.sendButtonText(m.chat, buttons, `Mode antivirtex`, atakbotz.user.name, m)
}
break
case 'antilink':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
ads(`Antilink Berhasil Di Aktifkan !`)
} else if (args[0] === "off") {
if (!global.db.data.chats[m.chat].antilink) return replyNya('Sudah Nonaktif Sebelumnya')
global.db.data.chats[m.chat].antilink = false
ads(`Antilink Berhasil Di Nonaktifkan !`)
} else {
let buttons = [
{ buttonId: 'antilink on', buttonText: { displayText: 'On' }, type: 1 },
{ buttonId: 'antilink off', buttonText: { displayText: 'Off' }, type: 1 }
]
await atakbotz.sendButtonText(m.chat, buttons, `Mode Antilink`, atakbotz.user.name, m)
}
break
case 'antiwame':
if (isBan) return ads('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
ads(`Antiwame Berhasil Di Aktifkan !`)
} else if (args[0] === "off") {
...
ads(`Antiwame Berhasil Di Nonaktifkan !`)
} else {
let buttons = [
...
for (let i of anu) {
 let metadata = await atakbotz.groupMetadata(i)
...
await atakbotz.sendButtonText(m.chat, buttons, `Mode Autosticker`, atakbotz.user.name, m)
}
					break
...
if (!isAdmins) throw mess.admin
if (args[0] === 'close'){
await atakbotz.groupSettingUpdate(m.chat, 'announcement').then((res) => replyNya(`Sukses Menutup Group`)).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'open'){
await atakbotz.groupSettingUpdate(m.chat, 'not_announcement').then((res) => replyNya(`Sukses Membuka Group`)).catch((err) => reply(jsonformat(err)))
} else {
let buttons = [
{ buttonId: 'group open', buttonText: { displayText: 'Open' }, type: 1 },
{ buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
]
await atakbotz.sendButtonText(m.chat, buttons, `Mode Group`, atakbotz.user.name, m)
}
}
break
case 'welcome': {
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (args.length < 1) return replyNya(`Contoh : ${prefix + command} XzyBotz`)
cantik = body.slice(1)
...
atakbotz.sendMessage(m.chat, { text: `${yn}%` }, { quoted: fakeatakbotz })
break
case 'jadian': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) throw mess.group
...
await atakbotz.sendButtonText(m.chat, buttons, jawab, atakbotz.user.name, m, {mentions: menst})
}
break
case 'bisakah':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
var media = await atakbotz.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
if (args[0] == `'panjang'`) {
var { img } = await generateProfilePicture(media)
await atakbotz.query({
tag: 'iq',
attrs: {
to: m.chat,
type:'set',
...
var memeg = await atakbotz.updateProfilePicture(m.chat, { url: media })
fs.unlinkSync(media)
reply(`Sukses`)
}
}
...
var memeg = await atakbotz.updateProfilePicture(botNumber, { url: media })
fs.unlinkSync(media)
reply(`Sukses`)
}
}
...
let media = await atakbotz.downloadAndSaveMediaMessage(quoted)
await atakbotz.updateProfilePicture(m.chat, { url: media }).catch((err) => fs.unlinkSync(media))
replyNya(mess.success)
}
break
...
if (!isAdmins) throw mess.admin
if (!text) throw 'Text ?'
await atakbotz.groupUpdateSubject(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'setmenu': {
            if (!isCreator) throw mess.owner
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                atakbotz.sendListMsg(m.chat, `Please select the menu you want to change!`, atakbotz.user.name, `Hello Owner !`, `Click Here`, sections, m)
                }
            }
            break                      
...
if (!isAdmins) throw mess.admin
if (!text) throw 'Text ?'
await atakbotz.groupUpdateDescription(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
}
break
case 'add': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
await atakbotz.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
case 'kick': case 'assalamualaikum':{
replyNya(`Fitur Ini Di Nonaktifkan Owner Karena Menyebabkan Nomor Bot Ke Banned 5 Kali`)
let message = await prepareWAMessageMedia({ image: fs.readFileSync('./Image/atakbotz.jpg') }, { upload: atakbotz.waUploadToServer })
}
break
case 'tagall': {
...
atakbotz.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: fakeatakbotz })
}
break
case 'hidetag': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) throw mess.group
if (!isAdmins) throw mess.admin
atakbotz.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: fakeatakbotz })
}
break
case 'promote': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
if (!isAdmins) throw mess.admin
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await atakbotz.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
case 'demote': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
if (!isAdmins) throw mess.admin
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await atakbotz.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
...
sticWait(from)
                    ...
                    atakbotz.sendMessage(m.chat, { image: fol, caption: ini_txt }, { quoted: fakeatakbotz})                  
                    get_audio = await getBuffer(ani.audio[0].link)
                    atakbotz.sendMessage(m.chat, {audio: get_audio, mimetype: 'audio/mpeg', fileName: `${ani.title}.mp3`}, { quoted : fakeatakbotz })
                    break
...
atakbotz.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `✇ Title : ${media.title}\n✇ File Size : ${media.filesizeF}\n✇ Url : ${isUrl(text)}\n✇ Ext : MP4\n✇ Resolusi : ${args[1] || '360p'}` }, { quoted: fkontak })
}
break
...
ads(mess.wait)
                ...
                if (media.filesize >= 999999) return ads('Audio size is too big '+util.format(media))
                atakbotz.sendImage(m.chat, media.thumb, `➣ Title : ${media.title}\n➣ File Size : ${media.filesizeF}\n➣ Url : ${isUrl(text)}\n➣ Ext : MP3\n➣ Resolution : ${args[1] || '320kbps'}`, m)
                atakbotz.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3` }, { quoted: fkontak })
            }
            break
case 'speed':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
if (!q) throw `Link Nya?`
sticWait(from)
atakbotz.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/ssweb?apikey=${lolkey}&url=${q}`}})
break
case 'xnxxsearch':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
atakbotz.sendMessage(from, { text: anu }, { quoted: fakeatakbotz })
break
              case 'spotifysearch':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
              if (!isPrem) return replyPremium(mess.premium)
...
sticWait(from)
                    ...
                    await atakbotz.sendMessage(m.chat, { image: fott, caption: ini_txt }, { quoted: fakeatakbotz})                  
                    break
case 'tiktokaudio':
case 'tiktokmusic':{
  if (!q) return ads('Linknya?')
    ads(mess.wait)
  if (!q.includes('tiktok')) return ads('Itu bukan link tiktok!')
   const musim_rambutan = await TiktokDownloader(`${q}`).catch(e => {
 ads(pesan.eror) 
} )
   console.log(musim_rambutan)
   const musim_duren_a = musim_rambutan.result.nowatermark
    atakbotz.sendMessage(from, { audio: { url: musim_duren_a }, mimetype: 'audio/mp4' }, { quoted: fkontak })
   }
 break
 case 'tiktok':
  case 'tiktoknowm':{
 ...
 fakey(pesan.eror) 
   ...
   const musim_duren_v = musim_rambutan.result.nowatermark
    atakbotz.sendMessage(from, { video: { url: musim_duren_v }, caption: "Done!" }, { quoted: fakeatakbotz })
   }
  break
case 'yts': case 'ytsearch': {
                ...
                atakbotz.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted: fkontak })
            }
            break
case 'hentai':
case 'ahegao':
...
atakbotz.sendMessage(m.chat, { image: { url: random }, caption: `Nih Kak` }, { quoted: fakeatakbotz })
}
break
...
atakbotz.sendMessage(m.chat, { image: { url: random.male }, caption: `Foto Couple Male` }, { quoted: fakeatakbotz })
atakbotz.sendMessage(m.chat, { image: { url: random.female }, caption: `Fofo Couple Female` }, { quoted: fakeatakbotz })
}
break
case 'tiktokstalk':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
let message = await prepareWAMessageMedia({ image: buffer }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
atakbotz.sendMessage(m.chat, { image: thumbnail, caption: ini_txt }, { quoted: fakeatakbotz})
break
case 'gsmarena': {
...
⭔ Detail: ${detail}`
            atakbotz.sendImage(m.chat, thumb, capt, m)
            }
            break
            case 'jadwalbioskop': {
            ...
            atakbotz.sendImage(m.chat, res.result[0].thumb, capt, m)
            }
            break
            ...
            atakbotz.sendImage(m.chat, res.result[0].img, capt, m)
            }
            break
            case 'aminio': {
            ...
            atakbotz.sendImage(m.chat, 'https://'+res.result[0].community_thumb, capt, m)
            }
            break
            case 'wattpad': {
            ...
            atakbotz.sendImage(m.chat, res.result[0].thumbnail, capt, m)
            }
            break
...
let message = await prepareWAMessageMedia({ image: wehw }, { upload: atakbotz.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
case 'anonymous': {
                ...
                atakbotz.sendButtonText(m.chat, buttons, `\`\`\`Hi ${await atakbotz.getName(m.sender)} Welcome To Anonymous Chat\n\nKlik Button Dibawah Ini Untuk Mencari Partner\`\`\``, atakbotz.user.name, m)
            }
			break
case 'sendkontak': case 'sendcontact': {
                ...
                if (!room) {
                    ...
                    await atakbotz.sendButtonText(m.chat, buttons, `_Kamu Sedang Tidak Berada Di Sesi Anonymous, Tekan Button Untuk Mencari Partner_`)
                    throw false
                }
                let profile = await atakbotz.profilePictureUrl(room.b)
                let status = await atakbotz.fetchStatus(room.b)
                let msg = await atakbotz.sendImage(room.a, profile, `Nama : ${await atakbotz.getName(room.b)}\nBio : ${status.status}\nUser : @${room.b.split("@")[0]}`, m, { mentions: [room.b] })
                atakbotz.sendContact(room.a, [room.b.split("@")[0]], msg)
            }
            break
            case 'keluar': case 'leave': {
                ...
                if (other) await atakbotz.sendText(other, `_Partner Telah Meninggalkan Sesi Anonymous_`, m)
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await atakbotz.sendButtonText(m.chat, buttons, `_Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda_`, atakbotz.user.name, m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await atakbotz.sendButtonText(room.a, buttons, `_Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan_`, atakbotz.user.name, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await atakbotz.sendButtonText(room.b, buttons, `_Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan_`, atakbotz.user.name, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await atakbotz.sendButtonText(m.chat, buttons, `_Mohon Tunggu Sedang Mencari Partner_`, atakbotz.user.name, m)
                }
                break
            }
            case 'next': case 'lanjut': {
                ...
                if (!romeo) {
                    ...
                    await atakbotz.sendButtonText(m.chat, buttons, `\`\`\`Kamu Sedang Tidak Berada Di Sesi Anonymous, Tekan Button Untuk Mencari Partner\`\`\``)
                    throw false
                }
                let other = romeo.other(m.sender)
                if (other) await atakbotz.sendText(other, `\`\`\`Partner Telah Meninggalkan Sesi Anonymous\`\`\``, m)
                ...
                if (room) {
                    ...
                    await atakbotz.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, atakbotz.user.name, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await atakbotz.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, atakbotz.user.name, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await atakbotz.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, atakbotz.user.name, m)
                }
                break
}
case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'artimimpi': case 'tafsirmimpi': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Mimpi :* ${anu.message.mimpi}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Solusi :* ${anu.message.solusi}`, m)
            }
            break
            case 'ramalanjodoh': case 'ramaljodoh': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Nama Anda :* ${anu.message.nama_anda.nama}\n⭔ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n⭔ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'suamiistri': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Nama Suami :* ${anu.message.suami.nama}\n⭔ *Lahir Suami :* ${anu.message.suami.tgl_lahir}\n⭔ *Nama Istri :* ${anu.message.istri.nama}\n⭔ *Lahir Istri :* ${anu.message.istri.tgl_lahir}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'artinama': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Nama :* ${anu.message.nama}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendImage(m.chat,  anu.message.gambar, `⭔ *Nama Anda :* ${anu.message.nama_anda}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan}\n⭔ *Sisi Positif :* ${anu.message.sisi_positif}\n⭔ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
            }
            break
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Tanggal Pernikahan :* ${anu.message.tanggal}\n⭔ *karakteristik :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Lahir :* ${anu.message.hari_lahir}\n⭔ *Usaha :* ${anu.message.usaha}`, m)
            }
            break
            ...
            case 'ramalannasib': case 'ramalnasib': case 'nasib': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Analisa :* ${anu.message.analisa}\n⭔ *Angka Akar :* ${anu.message.angka_akar}\n⭔ *Sifat :* ${anu.message.sifat}\n⭔ *Elemen :* ${anu.message.elemen}\n⭔ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendImage(m.chat, anu.message.image, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Simbol Tarot :* ${anu.message.simbol_tarot}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
            ...
            case 'haribaik': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Kala Tinantang :* ${anu.message.kala_tinantang}\n⭔ *Info :* ${anu.message.info}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'harinaas': case 'harisial': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Hari Lahir :* ${anu.message.hari_lahir}\n⭔ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n⭔ *Hari Naas :* ${anu.message.hari_naas}\n⭔ *Info :* ${anu.message.catatan}\n⭔ *Catatan :* ${anu.message.info}`, m)
            }
            break
            ...
            case 'weton': case 'wetonjawa': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Tanggal :* ${anu.message.tanggal}\n⭔ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n⭔ *Watak Hari :* ${anu.message.watak_hari}\n⭔ *Naga Hari :* ${anu.message.naga_hari}\n⭔ *Jam Baik :* ${anu.message.jam_baik}\n⭔ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
            }
            break
            ...
            case 'memancing': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Tanggal :* ${anu.message.tgl_memancing}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'shio': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                atakbotz.sendText(m.chat, `⭔ *Hasil :* ${anu.message}`, m)
            }
            break     
case 'list':
            ...
            atakbotz.sendMessage(from, listMsg)
            break
case 'cekproses':{
            if (!m.isGroup) return reply(mess.group)
        ...
        if (!m.isGroup) return reply(mess.group)
            ...
            if (/image/.test(mime)) {
              let media = await atakbotz.downloadAndSaveMediaMessage(m.message.imageMessage || m.message.extendedTextMessage?.contextInfo.quotedMessage.imageMessage, 'image')
...
`.trim()
atakbotz.sendText(m.chat, teks, m, { mentions: Object.values(global.db.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
}
addCmd(command.slice(0), 1, commund)
break
case 'lockcmd': {
...
atakbotz.copyNForward(m.chat, msgs[text.toLowerCase()], true)
}
addCmd(command.slice(0), 1, commund)
break
case 'listmsg': {
...
footer: "© XzyBotz - X - Barr",
title: "     「 List Respon Message 」",
buttonText: "List Message",
sections
}
atakbotz.sendMessage(from, listMessage, {quoted:m})
} catch {
...
atakbotz.sendMessage(from, {image:{url:nye}, caption:"Done!"}, { quoted: fkontak })
break               
