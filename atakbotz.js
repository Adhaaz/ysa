...
atakbotz.relayMessage(jid, order.message, { messageId: order.key.id})
        ...
        atakbotz.sendMessage(from, { text: mess.error }, { quoted: fkontak })
...
if (!isPrem) return replyPremium(mess.premium)
                ...
                if (args[0] === "lagu") {
                    ...
                    let msg = await atakbotz.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: fkontak })
...
case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
                ...
                atakbotz.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted: fkontak })
                fs.unlinkSync(ran)
                })
...
if (/webp/.test(mime)) {
atakbotz.sendMessage(i, { sticker: { url: media } }, { quoted: fkontak })
} else if (/image/.test(mime)) {
...
atakbotz.sendMessage(m.chat, { video: { url: hasiltod.result }, mimetype: 'video/mp4', fileName: `asupan.mp4`, caption: `Nih Asupan Nya` }, { quoted: fkontak })
}
break
case 'ghea':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { video: { url: hasilwjd.result.url }, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Asupan Nya` }, { quoted: fkontak })
}
break
case 'ukhty':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { video: { url: hasifs.result.url }, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Asupan Nya` }, { quoted: fkontak })
}
break
case 'santuy':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { video: { url: hasily.result.url }, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Asupan Nya` }, { quoted: fkontak })
}
break
case 'bokep':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Bokep Nya` }, { quoted: fkontak })
}
break
case 'storyanime':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { video: { url: hasiltod.result }, mimetype: 'video/mp4', fileName: `storyanime.mp4`, caption: `Nih Story Animenya` }, { quoted: fkontak })
}
break
case 'out':{
if (!isCreator) return replyNya(mess.owner)
...
atakbotz.sendMessage(m.chat, { image: buffer }, { quoted: fkontak })
fs.unlinkSync(ran)
})
}
break
...
atakbotz.sendMessage(m.chat, { sticker: gehdhe }, { quoted: fkontak })
break
case 'ttp':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (args.length == 0) return replyNya(`Contoh: ${prefix + command} Hai`)
...
atakbotz.sendMessage(m.chat, { sticker: veireuue }, { quoted: fkontak })
break
...
await atakbotz.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Converted From Webp To Video' } }, { quoted: fkontak })
await fs.unlinkSync(media)
}
break
case 'tourl': {
...
let media = await atakbotz.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await atakbotz.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Converted From Webp To Gif' }, gifPlayback: true }, { quoted: fkontak })
await fs.unlinkSync(media)
}
break
case 'emojimix':
...
atakbotz.sendMessage(m.chat, {document: mnya, mimetype: 'application/zip', fileName: `${kfeh.result.filename}`}, {quoted:fkontak}).catch ((err) => reply(oh))
}
break
case 'iqra': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:fkontak}).catch ((err) => reply(oh))
}
break
...
if (args[0] === 'pdf') {
ads(mess.wait)
atakbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:fkontak})
} else if (args[0] === 'docx') {
ads(mess.wait)
atakbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:fkontak})
} else if (args[0] === 'pptx') {
sticWait(from)
atakbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:fkontak})
} else if (args[0] === 'xlsx') {
sticWait(from)
atakbotz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:fkontak})
} else {
...
if (!isPrem) return replyPremium(mess.premium)
                    ...
                    await atakbotz.sendMessage(m.chat, { image: eahdw, caption: ini_txt }, { quoted: fkontak})                  
                    break
case 'pinterest':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
sticWait(from)
                    ...
                    await atakbotz.sendMessage(m.chat, { image: ini_buffer, caption: '*PINTEREST IMAGE*' }, { quoted: fkontak})                  
                    break
case 'pinterest2':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
                    if (args.length == 0) return reply(`Example: ${prefix + command} loli kawaii`)
                    ...
                    for (var x = 0; x <= 5; x++) {
                        ...
                        await await atakbotz.sendMessage(m.chat, { image: ini_buffer, caption: '*PINTEREST IMAGE*' }, { quoted: fkontak})                  
                    }
                    break
case 'character':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
sticWait(from)
                    ...
                    await atakbotz.sendMessage(m.chat, { image: gnejws, caption: ini_txt }, { quoted: fkontak})                  
                    break
case 'manga':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
sticWait(from)
                    ...
                    await atakbotz.sendMessage(m.chat, { image: cehdhw, caption: ini_txt }, { quoted: fkontak})                  
                    break
case 'kusonime':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
case 'lava': case 'rock': case 'bloodglas': case 'hallowen': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
             ...
             let anu = await maker.textpro(link, q)
                atakbotz.sendMessage(m.chat, { image: { url: anu }, caption: `*Done*` }, { quoted: fkontak })
             }
break
...
sticWait(from)
                    ...
                    atakbotz.sendMessage(m.chat, { image: ini_buffer, caption: `*KTP MAKER*` }, { quoted: fkontak})
                    break
case 'tiktokmaker':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
setTimeout( () => {
atakbotz.sendMessage(from, { text: '🚧 Selesai Menguli . . .🪙👷' }, { quoted: fkontak })
}, 7000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: '🚧 Menemukan Emas . . .⚒️🏔️️️' }, { quoted: fkontak })
}, 4000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: '🚧 Mulai Menambang . . .⚒️🏔️️' }, { quoted: fkontak })
}, 1500) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: mining }, {quoted: fkontak}) 
}, 0) // 1000 = 1s,
break
case 'inventori':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
setTimeout( () => {
atakbotz.sendMessage(from, { text: 'Berhasil Mendapatkan Ikan . . .' }, { quoted: fkontak })
}, 5000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: '🎣 Menarik Kail. . .' }, { quoted: fkontak })
}, 3000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: '🎣 Mulai Memancing . . .' }, { quoted: fkontak })
}, 1500) // 1000 = 1s,
...
setTimeout( () => {
atakbotz.sendMessage(from, { text: `Awass` }, { quoted: fkontak })
}, 5000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: `Tiba Tiba Ada ${sesuatu}` }, { quoted: fkontak })
}, 3000) // 1000 = 1s,
setTimeout( () => {
atakbotz.sendMessage(from, { text: `${pushname} Sedang Bertualang` }, { quoted: fkontak })
}, 1500) // 1000 = 1s,
...
atakbotz.sendMessage(m.chat, { text: `${yn}%` }, { quoted: fkontak })
break
case 'jadian': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) throw mess.group
...
atakbotz.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: fkontak })
}
break
case 'hidetag': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) throw mess.group
if (!isAdmins) throw mess.admin
atakbotz.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: fkontak })
}
break
case 'promote': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
sticWait(from)
                    ...
                    atakbotz.sendMessage(m.chat, { image: fol, caption: ini_txt }, { quoted: fkontak})                  
                    get_audio = await getBuffer(ani.audio[0].link)
                    atakbotz.sendMessage(m.chat, {audio: get_audio, mimetype: 'audio/mpeg', fileName: `${ani.title}.mp3`}, { quoted : fkontak })
                    break
...
atakbotz.sendMessage(from, { text: anu }, { quoted: fkontak })
break
              case 'spotifysearch':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
              if (!isPrem) return replyPremium(mess.premium)
...
sticWait(from)
                    ...
                    await atakbotz.sendMessage(m.chat, { image: fott, caption: ini_txt }, { quoted: fkontak})                  
                    break
case 'tiktokaudio':
case 'tiktokmusic':{
 ...
 fakey(pesan.eror) 
   ...
   const musim_duren_v = musim_rambutan.result.nowatermark
    atakbotz.sendMessage(from, { video: { url: musim_duren_v }, caption: "Done!" }, { quoted: fkontak })
   }
  break
...
atakbotz.sendMessage(m.chat, { image: { url: random }, caption: `Nih Kak` }, { quoted: fkontak })
}
break
...
atakbotz.sendMessage(m.chat, { image: { url: random.male }, caption: `Foto Couple Male` }, { quoted: fkontak })
atakbotz.sendMessage(m.chat, { image: { url: random.female }, caption: `Fofo Couple Female` }, { quoted: fkontak })
}
break
case 'tiktokstalk':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
atakbotz.sendMessage(m.chat, { image: thumbnail, caption: ini_txt }, { quoted: fkontak})
break
case 'gsmarena': {
